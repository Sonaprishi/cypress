...
describe("Edit Profile", () => {
    beforeEach(() => {
      ...
      cy.get("#password").should("not.be.disabled").type("4321");
    ...
    it("Usr FA", () => {
      var file = "../fixture/example.json"
        ...
        cy.get('#MenuHeader1 > :nth-child(6) > a').click();
        ...
        cy.get('#ddlCondition').select("Condition 1")
        ...
        cy.get('#paramremark5').type("User is configuring Bid to ge quotes and select the vendor this Bid involves Scrap and metals and plastics");
        cy.get('#paramremark6').type("User is configuring Bid to ge quotes and select the vendor this Bid involves Scrap and metals and plastics");
